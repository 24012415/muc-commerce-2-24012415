...
- 学号：24012415
- 专题方向：A
- 已完成功能：登录退出，4张指标卡和两张真实图表，偏好品类筛选，智能问答
- 选择的拓展任务：A
- 拓展访问或运行方法：1. 终端进入项目根目录day07_web_student，执行python app.py启动服务；
  2. 浏览器访问 http://127.0.0.1:5000/dashboard 进入数据看板；
  3. 操作方式一：页面下拉框选择品类，点击【导出当前品类筛选数据】按钮下载；
  4. 操作方式二：直接访问接口地址，全品类：/download；指定品类：/download?category=品类名。
- 拓展证据文件：Fashion_用户品类分析表,screenshots05_extension.png
- 尚未解决的问题：拓展B,C
